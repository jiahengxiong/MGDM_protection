    ...
    def get_topology(self):
        ...
        for i in range(1, 51):
            G.add_edge(1, 7, distance=306,
                       occupied_mode=(), working_requests=[], protection_requests=[], type=f'wavelength{i}',
                       occupied_modulation=None,
                       min_distance=0, backup_mode=[], occupied_rate=0, backup_rate=[], backup_distance=[],
        ...
        for u, v, key, data in G.edges(data=True, keys=True):
            G[u][v][key]['distance'] = 3 * data['distance']/400

        """for u, v, key, data in G.edges(data=True, keys=True):
            if (u, v) not in [(8, 11),  (8, 10),  (8, 14), (8, 2),  (8, 1)]:
